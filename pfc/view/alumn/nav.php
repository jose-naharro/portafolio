<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
        <ul class="navbar-nav">    
            <li class="nav-item">    
                <a class="navbar-brand" href="<?php echo urlsite?>?page=4">
        ...
        <div class="collapse navbar-collapse" id="navbarText">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo urlsite?>?page=4">Inicio</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo urlsite ?>?page=4&section=listarVuelos">Vuelos</a>
                </li>
            </ul>
            <div class="linkUsuario">
                <a href="<?php echo urlsite ?>?page=4&section=detallesUsuario">
