            ...
            <div class="card bg-dark">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div class="d-flex flex-row">
                        <a href="<?php echo urlsite?>?page=2&section=formInsertarVuelo" class="btn btn-primary new"><i class="fa fa-plus"></i> Añadir</a>
                    </div>
        ...
        <tbody>
            ...
            <?php }else{
                foreach ($listaVuelos as $index=>$vuelo):?>
                    <tr>
                        <th scope="row"><?php echo $index+1;//echo $vuelo->flight_id?></th>
                        ...
                        <td>
                            <a href="<?php echo urlsite?>?page=2&section=verVuelo&id=<?php echo $vuelo->flight_id?>" class="btn btn-success">Ver</a>
                            <a href="<?php echo urlsite?>?page=2&section=formEditarVuelo&id=<?php echo $vuelo->flight_id?>" class="btn btn-primary">Editar</a>
                            <a href="<?php echo urlsite ?>?page=2&section=eliminarVuelo&id=<?php echo $vuelo->flight_id?>" onclick="return confirm('¿Confirma el borrado de este vuelo, Si o No?')" class="btn btn-danger">Borrar</a>
                        </td>
                    </tr>
                <?php endforeach;
            } ?>
