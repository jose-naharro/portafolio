    ...
    <div class="row d-flex justify-content-center">
        <div class="col-xl-6 col-lg-7 col-md-8 col-10 text-center">
            ...
            <div class="card text-white bg-dark">
                <form action="<?php echo urlsite ?>?page=2&section=insertarVuelo" enctype="multipart/form-data" method="POST" class="form-card">
                    ...
                    <div class="row justify-content-between text-left">
                        <div class="form-group col-sm-6 flex-column d-flex">
                            ...
                            <select class="form-select form-select-lg" id="f_pic" name="f_pic"  required>
                                <option style="display:none">Alumno...</option>
                                <?php foreach ($listaAlumnos as $alumno):?>
                                    <option value="<?php echo $alumno->user_id?>"><?php echo $alumno->user_name." ".$alumno->user_surname1." ".$alumno->user_surname2?></option>
                                <?php endforeach; ?>
                            </select> 
                        </div>
                        <div class="form-group col-sm-6 flex-column d-flex">
                            <label class="form-control-label px-3 text-white">Instructor</label> 
                            <select class="form-select form-select-lg" id="f_inst" name="f_inst"  required>
                                <option style="display:none">Instructor...</option>
                                <?php foreach ($listaInstructores as $instructor):?>
                                    <option value="<?php echo $instructor->user_id?>"><?php echo $instructor->user_name." ".$instructor->user_surname1." ".$instructor->user_surname2?></option>
                                <?php endforeach; ?>
                            </select> 
                        </div>
                    </div>
                    <div class="row justify-content-between text-left">
                        ...
                        <div class="form-group col-sm-3" id="checkDiv">
                            ...
                            <input type="checkbox" class="checkActive" id="f_train" name="f_train" name="check[0]" value="1">
