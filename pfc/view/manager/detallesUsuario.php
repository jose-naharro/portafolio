    ...
    <div class="row d-flex justify-content-center">
        <div class="col-xl-6 col-lg-7 col-md-8 col-10 text-center">
            ...
            <div class="card text-white bg-dark">
                <form action="<?php echo urlsite ?>?page=1&section=editarDetalles" enctype="multipart/form-data" method="POST" class="form-card">
                    ...
                    <div class="row justify-content-between text-left">
                        ...
                        <div class="form-group col-sm-6" id="cambioPass">
                            <a class="btn btn-success" href="<?php echo urlsite ?>?page=1&section=changePassword" onclick="return confirm('Va a cerrar sesión y abandonar la página para poder cambiar la contraseña de manera segura, se perderán los cambios no guardados ¿desea continuar?')">Cambiar Contraseña</a>
                    ...
                    <div class="row justify-content-center">
                        <div class="form-group col-sm-6">
                            ...
                            Guardar</button>
                            <button type="button" class="btn-block btn-secondary" onclick="location.href='<?php echo urlsite ?>?page=1'">Cancelar
                            </button>
                        </div>
                    </div>
                </form>
