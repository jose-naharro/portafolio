            ...
            <div class="card bg-dark">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div class="d-flex flex-row">
                        <a href="<?php echo urlsite?>?page=1&section=formInsertarAeronave" class="btn btn-primary new"><i class="fa fa-plus"></i> Añadir</a>
                    </div>
            ...
            <?php }else{
                foreach ($listaAeronaves as $index=>$aeronave):?>
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo urlsite?>?page=1&section=verAeronave&id=<?php echo $aeronave->plane_id?>" class="btn btn-success">Ver</a>
                            <a href="<?php echo urlsite?>?page=1&section=formEditarAeronave&id=<?php echo $aeronave->plane_id?>" class="btn btn-primary">Editar</a>
                            <a href="<?php echo urlsite ?>?page=1&section=eliminarAeronave&id=<?php echo $aeronave->plane_id?>" onclick="return confirm('¿Confirma el borrado de esta aeronave, Si o No?')" class="btn btn-danger">Borrar</a>
                        </td>
                    </tr>
                <?php endforeach;
            }?>
