    ...
    <div class="row d-flex justify-content-center">
        <div class="col-xl-6 col-lg-7 col-md-8 col-10 text-center">
            ...
            <div class="card text-white bg-dark">
                <form action="<?php echo urlsite ?>?page=3&section=editarVuelo" enctype="multipart/form-data" method="POST" class="form-card">
                    ...
                    <div class="row justify-content-between text-left">
                        ...
                        <div class="form-group col-sm-4 flex-column d-flex">
                            ...
                            <input type="text" id="f_dep_e_dis" name="f_dep_dis" value="<?php echo $vuelo[0]->flight_dep ?>" disabled>
                            <input type="hidden" id="f_dep_e" name="f_dep_e" value="<?php echo $vuelo[0]->flight_dep ?>">
                        </div>
                        <div class="form-group col-sm-4 flex-column d-flex">
                    ...
                    <div class="row justify-content-between text-left">
                        ...
                        <div class="form-group col-sm-6 flex-column d-flex">
                            ...
                            <input type="text" id="f_inst_e_dis" name="f_inst_e_dis" value="<?php echo $vuelo[0]->inst ?>" disabled>
                            <input type="hidden" id="f_inst_e" name="f_inst_e" value="<?php echo $vuelo[0]->flight_inst ?>">
                        </div>
                    </div>
                    <div class="row justify-content-between text-left">
                        <div class="form-group col-sm-4 flex-column d-flex">
                        ...
                        <div class="form-group col-sm-3" id="checkDiv">
                            <input type="checkbox" class="checkActive" id="f_train_e_dis" name="f_train_e" value="<?php echo $vuelo[0]->flight_isTrain ?>"<?php  if ($vuelo[0]->flight_isTrain) : echo " checked"; endif?> disabled>
                            <input type="hidden" class="checkActive" id="f_train_e" name="f_train_e" name="f_train_e" value="<?php echo $vuelo[0]->flight_isTrain ?>"<?php  if ($vuelo[0]->flight_isTrain) : echo " checked"; endif?>>
                            <label class="form-control-label px-3 text-white" id="checkLabel" for="f_train_e_dis">Instrucción</label> 
                        </div>
                    </div>
                    <div class="row justify-content-between text-left">
