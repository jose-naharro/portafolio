            ...
            <?php }else{
                foreach ($listaVuelos as $index=>$vuelo):?>
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo urlsite?>?page=3&section=verVuelo&id=<?php echo $vuelo->flight_id?>" class="btn btn-success">Ver</a>
                            <a href="<?php echo urlsite?>?page=3&section=formEditarVuelo&id=<?php echo $vuelo->flight_id?>" class="btn btn-primary">Editar</a>
                        </td>
                    </tr>
                <?php endforeach;
            } ?>
