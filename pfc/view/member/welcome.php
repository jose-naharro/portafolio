               ...
               <div class="row">
                  <div class="col-sm-6 text-center">
                     <div class="card bg-dark d-flex justify-content-center text-center">
                        ...
                        <div class="card-body">
                           <a href="<?php echo urlsite ?>?page=5&section=listarVuelos" class="btn btn-primary">Vuelos</a>
                        </div>
                     </div>
                  </div>
                  <div class="col-sm-6 text-center">
                     <div class="card bg-dark d-flex justify-content-center text-center">
                        ...
                        <div class="card-body">
                           <a href="<?php echo urlsite ?>?page=5&section=listaAeronaves" class="btn btn-primary">Aeronaves</a>
                        </div>
                     </div>
                  </div>
               </div>
